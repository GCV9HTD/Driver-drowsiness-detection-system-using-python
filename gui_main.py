...
def ped():
    ...
    # Open the video
    cap = cv2.VideoCapture("videoplayback.mp4")  #"videoplayback.mp4"
    while True:
        ret, frame = cap.read()
        if ret == False:
            break
...
loginbt = Button(R1,text = "drowsiness detection",width=15,height=2,bg=g,fg="white",font="5",relief=RAISED,overrelief=RIDGE,command=main)

loginbt1 = Button(R1,text = "pedestrian detection",width=15,height=2,bg=g,fg="white",font="5",relief=RAISED,overrelief=RIDGE,command=ped)
signUpbt = Button(R1,text = "head bend",width=10,height=2,bg=g,fg="white",font="5",relief=RAISED,overrelief=RIDGE,command=head)
